    ...
    return (
        ...
        <article className="about-container">
            <div className="about-box about-box-overlay">
                ...
                <p><img className="about-floating-image" src="mario-and-adrian-b.jpg" alt="mario and adrian b"/>
                </p>
                <p><img className="about-floating-image-top"src="mario-and-adrian-a.jpg" alt="mario and adrian a"/></p>
